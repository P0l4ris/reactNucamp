...
//+ turns value into number
const isNumber = val => !isNaN(+val);
// .test is JS that tests to see if value is regex pattern
                    ...
                    <div className="col-md-10">
                        <LocalForm onSubmit={ values => this.handleSubmit(values)}>
                            ...
                            <Row className="form-group">
                                ...
                                <Col md={10}> 
                                    {/* Col md={10}same as className="col" also htmlFor on label
                                    or offset-md-2 and the values are set up as this.state.value
                                    and each input gets a handleIC handler as well as a submit handler for the entire form*/}
                                    {/* model will store state in specific place with dot */}
                                    ...
                                    />
                                    {/* everything has set simple react components */}
                                    <Errors
